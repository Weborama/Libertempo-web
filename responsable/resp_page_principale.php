...
$congesExceptionnels = ($_SESSION['config']['gestion_conges_exceptionnels'])
    ? $tab_type_conges_exceptionnels
    : [];

$gestionHeure = $_SESSION['config']['gestion_heures'];
$gestionEditionPapier = $_SESSION['config']['editions_papier'];
...
$subalternesGrandResponsable = ($_SESSION['config']['double_validation_conges'])
